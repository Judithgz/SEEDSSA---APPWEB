        ...
        <div class="card-body">
            <ul>
                ...
                @if($role == 'paciente' || $role == 'admin')
                    <dd>
                        <strong>Especialista:</strong> {{$appointment->colaboradores->name}}
                    </dd>
                @endif
                ...
                <dd>
                    <strong>Tipo de paciente:</strong> {{$appointment->type}}
                </dd>
                <dd>
                ...
                <dd>
                    <strong>Comentarios:</strong> {{$appointment->description}}
                </dd>
            </ul>
